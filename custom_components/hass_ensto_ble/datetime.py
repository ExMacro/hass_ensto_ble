...
class EnstoVacationDateTimeEntity(EnstoBaseEntity, DateTimeEntity):
    ...
    async def async_set_value(self, value: datetime) -> None:
       ...
       try:
           ...
           temp_offset_entity_id = None
           power_offset_entity_id = None

           for entry in registry.entities.values():
               if entry.unique_id == temp_unique_id:
                   temp_offset_entity_id = entry.entity_id
               elif entry.unique_id == power_unique_id:
                   power_offset_entity_id = entry.entity_id
